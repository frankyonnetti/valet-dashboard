  ...
  <div class="container color-mode">
    ...
    <aside class="sidebar color-mode">
      ...
      <ul class="sidebar-container server-list color-mode">
        ...
        <li class="server-version phpmyadmin" style="display: none;">
          <span class="tech-label">
            <!-- https://phpmyadmin.test -->
            <a href="#">phpMyAdmin</a>
          </span>
          <span class="tech-info">
            <!-- Brew install path: /usr/local/Cellar/phpmyadmin/5.x/share/phpmyadmin -->
          </span>
        </li>
      </ul>

      <div class="sidebar-container settings color-mode">
      ...
      <footer class="footer color-mode">
        <p>Valet Dashoard v0.4.2 / <a href="https://github.com/frankyonnetti/valet-dashboard" tabindex="-1">Github</a></p>
      </footer>
